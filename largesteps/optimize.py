...
# class AdamUniformModified(torch.optim.Optimizer):
#     """
#     Variant of Adam with uniform scaling by the second moment.
...
#     def __init__(self, params, lr=0.1, betas=(0.9,0.999)):
#         defaults = dict(lr=lr, betas=betas)
#         super(AdamUniformModified, self).__init__(params, defaults)

#     def __setstate__(self, state):
#         super(AdamUniformModified, self).__setstate__(state)

#     @torch.no_grad()
#     def step(self, pgrads):
#         for group in self.param_groups:
#             lr = group['lr']
#             b1, b2 = group['betas']
